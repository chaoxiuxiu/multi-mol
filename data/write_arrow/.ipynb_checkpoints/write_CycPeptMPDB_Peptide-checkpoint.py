...
make_arrow(root='/root/autodl-tmp/myCLIP/data/downstreamDataset/ADMETlab_data/CycPeptMPDB_Peptide',
           data_split_path='train.json',
           dataset_root = '/root/autodl-tmp/myCLIP/data/downstreamDataset/ADMETlab_data/CycPeptMPDB_Peptide',
           split = 'train'
           )
